...
import { Bell, CreditCard, PiggyBank, AlertTriangle, Clock, Loader2 } from "lucide-react";
        ...
        {insights?.map((n, i) => {
          ...
          return (
            <motion.div
              ...
              className="flex items-start gap-3 rounded-2xl p-4 bg-card shadow-card border border-muted-foreground/5 hover:border-primary/20 transition-all"
            >
